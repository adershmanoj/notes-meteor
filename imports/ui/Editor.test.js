...
if(Meteor.isClient){
  describe('Editor', function(){
    ...
    it('should render pick note message', function(){
      ...
      expect(wrapper.find('p').text()).toBe('Pick or create a note to get selected');
    });
    
    it('should render note not found', function(){
      const wrapper = mount(<Editor browserHistory={browserHistory} call={call} selectedNoteId='testId1'/>);
